  ...
  <table id="productTable" class="am-table am-table-bordered am-table-striped am-table-hover no-margin-bottom" style="width:100%;">
    ...
    <tr>
      <td colspan="999" style="background-color:#FFF">
        <button class="am-btn am-btn-primary am-btn-sm" type="button" onClick="addCoreProduct()"><span class="am-icon-plus"></span> 新增班组</button>
      </td>
    </tr>
    <tr class="am-primary" style="border-right: 0px;">
      ...
      <th style="width: 10%;">产能（小时）</th>
      <th style="width: 10%;">最小批量</th>
      <th>操作</th>
    </tr>
