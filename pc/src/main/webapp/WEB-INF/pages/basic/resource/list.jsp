...
<table class="am-table am-table-bordered am-table-striped am-table-hover" style="width:100%;">
  ...
  <c:forEach var="resource" items="${resourceList}" varStatus="status">
    <tr>
      ...
      <td>
        <a class="am-badge am-badge-secondary am-radius am-text-lg" onClick="editResource(${resource.id})"><span class="am-icon-edit"></span> 修改</a>
        <a class="am-badge am-badge-danger am-radius am-text-lg" onClick="delResource(${resource.id})"><span class="am-icon-trash-o"></span> 删除</a>
      </td>
    </tr>
  </c:forEach>
</table>
