...
<p /><p />
  ...
  <table id="findProductCgTable" class="am-table am-table-bordered am-table-striped am-table-hover" style="width:200%; overflow: auto">
    <tr class="am-primary" style="border-right: 0px;">
      <th style="width:5%;" rowspan="4">物料名称</th>
      <th style="width:5%;" rowspan="4">物料编码</th>
      <th style="width:5%;" rowspan="4">客户需求</th>
      <th style="width:5%;" rowspan="4">初期库存</th>
    </tr>
    <tr class="am-primary" style="border-right: 0px;">
