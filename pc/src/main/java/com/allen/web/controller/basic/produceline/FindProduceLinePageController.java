 ...
 */
@Controller
@RequestMapping(value = "/findProduceLinePage")
public class FindProduceLinePageController extends BaseController {
    @Resource
    private FindProduceLinePageService findProduceLinePageService;
    ...
    public String find(@RequestParam(value="name", required=false) String name,
        ...
        sortMap.put("id", true);
        pageInfo = findProduceLinePageService.find(pageInfo, params, sortMap);
